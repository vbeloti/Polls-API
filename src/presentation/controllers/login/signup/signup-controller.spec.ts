...
import { AddAccount, AddAccountParams, AccountModel, HttpRequest, Validation, Authentication, AuthenticationParams } from './signup-protocols-controller';
import { ok, serverError, badRequest, forbidden } from '../../../helpers/http/http-helper';
import { mockAccountModel, throwError } from '@/domain/test';
import { mockAuthentication, mockValidation } from '@/presentation/test';
import { mockAddAcount } from '@/presentation/test/mock-account';
